        ...
        <div style={{ 
          ...
          <div className="grid grid-4" style={{ gap: '2rem' }}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#1976d2', marginBottom: '0.5rem' }}>95%</div>
              <div style={{ color: '#94a3b8', fontSize: '0.95rem', fontWeight: '600' }}>Faster Processing</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#daa520', marginBottom: '0.5rem' }}>99.8%</div>
              <div style={{ color: '#94a3b8', fontSize: '0.95rem', fontWeight: '600' }}>Accuracy Rate</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#1976d2', marginBottom: '0.5rem' }}>24/7</div>
              <div style={{ color: '#94a3b8', fontSize: '0.95rem', fontWeight: '600' }}>Availability</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#daa520', marginBottom: '0.5rem' }}>100%</div>
